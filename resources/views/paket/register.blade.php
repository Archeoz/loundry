                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Register Paket</h1>
                        </div>
                        <form class="user" action="{{ url('laundry/registerpaket') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 mb-3 mb-sm-0">
                                    <input type="number" class="form-control form-control-user" id="exampleFirstName" name="harga"
