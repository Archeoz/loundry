            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" action="{{ url('laundry/updateuser/'.$user->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="form-group">
                                <input type="nama" class="form-control form-control-user" id="exampleInputEmail" name="nama" value="{{ $user->nama }}"
                                    placeholder="Name">
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user" id="exampleFirstName" name="username" value="{{ $user->username }}"
